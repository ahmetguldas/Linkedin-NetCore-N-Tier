...
namespace Business.Services
{
    public class LicenseOfCertificationService : ILicenseOfCertificationService
    {
        ...
        public void DeleteLicenseOfCertification(int id)
        {
        ...
        public LicenseOfCertification GetLicenseOfCertificationById(int id)
        {
        ...
        public void UpdateLicenseOfCertificationImage(string ImageUrl, int id)
        {
